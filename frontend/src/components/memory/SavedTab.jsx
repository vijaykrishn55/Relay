  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h2 className="text-lg font-semibold text-gray-800">Saved Memories</h2>
          <p className="text-sm text-gray-500">
            {memories.length} memor{memories.length === 1 ? 'y' : 'ies'} — auto-injected when relevant
          </p>
        </div>
        <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-purple-600 text-white text-[10px] font-medium">
