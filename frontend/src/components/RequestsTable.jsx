                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                        <tr>
                                                ...
                                                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Model Used</th>
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                        {requests.map((request, index) => (
                                                <tr key={index} className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                        ...
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{request.latency}</td>
                                                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{request.cost}</td>
                                                        <td className="px-6 py-4 whitespace-nowrap">
                                                                <p className={`px-2py-1text-xsfont-mediumrounded-full ${
